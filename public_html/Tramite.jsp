...
%>
    ...
    <tr>
      ...
      <td style="text-align:left"><html:text property="registro" maxlength="10" size="12"/></td>
    </tr>
    
    <tr>
        <th><%if(cs.getOpcion()==2) { %>Dep&oacute;sito Transitorio:<%}%></th>
        <td style="text-align:left">
        <%
        if(cs.getOpcion()==2) {
        
        %>
        <html:radio property="deposito" value="NO"/>NO
        <html:radio property="deposito" value="SI"/>SI
        <%
