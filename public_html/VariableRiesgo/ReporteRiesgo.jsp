...
<input type="hidden" name="boton" id="boton"/>
  ...
  <table width="50%" border="0" cellpadding="4" cellspacing="0" class="marco" id="a">
    <caption><label style="font-size:15px">Reportes - Riesgos Identificados por Variable de Riesgo</label></caption>
 ...
 try
  { sql.getConexion();
    ...
    call = sql.cn.prepareCall( "{? = call PKG_VARIABLE_RIESGO.reporte2( ?,?,? ) }" );
    ...
    <table width="90%" border="0" cellpadding="3" cellspacing="0" align="center">
        <tr>
            <th><label style="font-size:15px">Riesgos Identificados por Variable de Riesgo</label></th>
        </tr>
    </table>
    <table width="90%" border="1" cellpadding="3" cellspacing="0" class="marco" align="center" id="c">
        <tr class="t14">
            ...
            <th align="center" >USUARIO OPERADOR</th>
            <th align="center" >FECHA DE HABILITACION</th>
            <th align="center" >FECHA DE DESHABILITACION</th>
        </tr>
