...
<html>
    ...
    <body>
        <div class="s40" >
            <html:form action="/regManifiestoAction" styleId="form1" styleClass="form" >   
                <br> 
                <br>
                    ...
                    try{    
                        ...
                        <table border="1" cellpadding="4" cellspacing="0" class="marco" id="e">
                            ...
                            if( !(rs == null || !rs.next() )){
                                do{
                                    ...
                                    String registraaut="return registraaut(5,'"+docemb_fecha_embarque+"', '"+key_cuo+"', '"+key_voy_nber+"','"+key_dep_date+"', '"+key_bol_ref+"', '"+docemb_fecha_embarque+"', '"+fd2751+"' , '"+fd2752+"', '"+fd2657+"' , '"+fd2600+"' , '"+fd2865+"' )";
                                    %>
                                    <tr>
                                    <%
                                    ...
                                    %>
                                        ...
                                        <td width="10%" align="center">
                                            <html:text property="docemb_fecha_embarque" styleId="docemb_fecha_embarque" size="11" maxlength="10" value="<%=docemb_fecha_embarque%>" title="Fecha Documento de Embarque"   />  
                                        </td> 
                                        <%
                                        if(aduanaAutPrevia.equals("0")){
                                        %>
                                    ...
                                    %>    
                                        ...
                                        %>
                                            <html:submit property="boton" styleClass="btnStyleOut" onmouseout="this.className='btnStyleOut'" onmouseover="this.className='btnStyleOver'" value="Completar" onclick="<%=edita%>"/>
                                        <%
                                        /*}*/
                                        %>  
                                        </td>
                        ...
                        <table>
                            ...
                            */
                            ...
                            <tr>
                                <td align="center">  
                                    <input type="button" styleClass="btnStyleOut" onmouseout="this.className='btnStyleOut'" onmouseover="this.className='btnStyleOver'" value="&nbsp;Registrar Documento de Embarque&nbsp;" onclick="<%=enviaaut%>"/>
                                </td>
                            </tr>
                        </table>
...
<script language="JavaScript" type="text/javascript" >
    ...
    function registraaut(opcion, fila, key_cuo, key_voy_nber, key_dep_date, key_bol_ref, fec_embarque, fd2751, fd2752, fd2657, fd2600, fd2865) {
        f = document.forms[1];
