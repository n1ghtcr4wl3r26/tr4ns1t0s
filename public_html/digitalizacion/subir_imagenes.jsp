    ...
    <head>
        ...
        <script>
          ...
          function grabar(){
            ...
            if (f.tipo_img.value == "") {
                Mensaje += "'Tipo de fotograf\355a' es obligatorio.\n";
            }
            if(f.imagen_prev.value == ""){
                Mensaje += "'Foto' es obligatorio.\n";
            }
            if (Mensaje != "") {
                alert(Mensaje);
                return false;
        ...
        <div class="s40">
            ...
            <table width="100%" border="0" cellpadding="3" cellspacing="0" id="a">
                ...
                <table width="100%" border="0" cellpadding="3" cellspacing="0" class="marco" id="a">
                    <caption>Fotograf&iacute;as Transporte</caption>
                     
                    <tr>
                        <th>*Tipo Fotograf&iacute;a:</th>
                        <td>
                            <html:select property="tipo_img">
                                <%
                                /*
                          ...
                          */ 
                                %>
                                <html:option value="">&lt;-- Seleccione Tipo --&gt;</html:option>
                                <html:option value="PRECINTO">PRECINTO</html:option>
                                      
                            </html:select>
                        </td>
                        <th>Adjuntar Foto:</th>
                        <td>
                            <input type="file" style="width:300px" accept="image/*" name="fileimg"
                                   onchange="handleFiles()" id="file_img2"></input>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td colspan="4" class="C">
                            <html:hidden property="imagen_prev" styleId="imagen_prev"/>
                            <center><input class="btn btn-primary" type="button" style="display:none;" id="btnregistrar"   value="Registrar" onclick="grabar();" /></center>
                        </td>
                    </tr>
                     
                    <tr>
                        <td colspan="4" class="C" align="center">
                            <img src="" id="imageprev" name="imagen_p"></img>
                        </td>
                    </tr>
                </table>
                <br>
          ...
          %>
                <div class="item item-type-line">
                    <a class="item-hover" href="<%=imagen2%>" target="_blank">
                        <div class="item-info">
                            <div class="headline">
                                <html:submit style="outline:none; border:none;width:20px;height:20px; font-size:1px; background-image: url(images/delete3.png)"
                                             value="X" onclick="<%=accionbtn%>"/>
                            </div>
                        </div>
