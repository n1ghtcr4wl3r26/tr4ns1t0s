...
<body>
    <html:form action="/justificativo">
        <%
        ...
        <table width="50%" border="0" cellpadding="4" cellspacing="0" class="marco" id="a">
            ...
            <tr>
                ...
                <td style="text-align:left">
                    <html:text property="key_year" styleId="key_year" styleClass="form-control" size="15"
                               maxlength="4"/>
                </td>
            </tr>
            ...
            <tr>
                ...
                <td style="text-align:left">
                    <html:text property="key_nber" styleId="key_nber" styleClass="form-control" size="15"
                               maxlength="6"/>
                </td>
            </tr>
            ...
            <tr>
                <td colspan="4" align="center">
                    <center>
                        <input class="btn btn-primary" type="button" style="cursor:pointer;" value="Consultar"
                               onclick="envia();"/>
                    </center>
                </td>
            </tr>
        ...
        <script type="text/javascript">
              function envia() {
                  ...
                  else if (!fNumero(f.key_year.value)) {
                  ...
                  else if (!fNumero(f.key_nber.value)) {
