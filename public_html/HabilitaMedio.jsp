...
<script language="JavaScript" type="text/JavaScript" src="js/HabilitaMedio.js"></script>
...
<html:form action="/HabilitaMedioAction" onsubmit="return fEvalua ( );">
  <table width="100%" border="0" cellpadding="3" cellspacing="0">
    <tr>
      <td class="t14">Habilitaci&oacute;n de Medios de Transporte</td>
    </tr>
  </table>
...
<%  ClaseSql sql = new ClaseSql();
    ...
    try {
      ...
      call = sql.cn.prepareCall( "{? = call PKG_ACTA.consulta_medios( ? ) }" );
