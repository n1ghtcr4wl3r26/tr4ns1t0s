	...
	var gotoString = "Ir para el mes actual"
	var todayString = "Hoy es"
	var weekString = "Sem"
	var scrollLeftMessage = "Clic para desplazarse al mes anterior. Mantenga pulsado el botón del ratón para desplazarse de forma automática."
	var scrollRightMessage = "Clic para desplazarse hasta el próximo mes. Mantenga pulsado el botón del ratón para desplazarse de forma automática."
	var selectMonthMessage = "Clic para seleccionar un mes."
	var selectYearMessage = "Clic para seleccionar un año."
	var selectDateMessage = "Seleccione [date] como la fecha." // do not replace [date], it will be replaced by date.
    ...
    */
	...
	if (dom)
	{
		...
		document.write ("<div width='50px' onclick='bShow=true' id='calendar'	style='z-index:+999;position:absolute;visibility:hidden;'><table	width="+((showWeekNumber==1)?250:220)+" style='font-family:arial;font-size:11px;border-width:1;border-style:solid;border-color:#a0a0a0;font-family:arial; font-size:11px}' bgcolor='#ffffff'><tr background='img/calback.JPG'><td background='img/calback.JPG'><table width='"+((showWeekNumber==1)?248:218)+"'>")
    document.write ("<tr><td style='padding:2px;font-family:arial; font-size:11px;'><font color='#FFFFFF'><B><span id='caption'></span></B></font></td><td align=right><a href='javascript:hideCalendar()'><IMG SRC='"+imgDir+"close.gif' BORDER='0' ALT='Cerrar calendario'></a></td></tr></table></td></tr><tr align=left ><td  align=left style='padding:5px' bgcolor=#ffffff><span id='conten'></span></td></tr>")
...
//CAMBIA el siguiente for por este " for	(i=yearNow; i<=(yearNow+4); i++) { " si quieres que los años empizen en el actual en adelante		
			for	(i=yearNow+5; i>=(yearNow-25); i--) {		
				sName =	i;
				if (i==yearSelected){
					sName =	"<B>" +	sName +	"</B>"
				}
   ...
   function WeekNbr(n) {
      ...
      as = Math.floor((14-month) / 12);
      y = year + 4800 - as;
      m = month + 12 * as - 3;
      bs = Math.floor(y/4) - Math.floor(y/100) + Math.floor(y/400);
      J = day + Math.floor((153 * m + 2) / 5) + 365 * y + bs - 32045;
...
//------------------------------------TERMINAR LA FUNCION EN 0 PARA QUE INICIE EN EL DIA ACTUAL EN LA SIGUIENTE LINEA----------------------------------------------
		...
		document.getElementById("conten").innerHTML   = sHTML
