...
var WeekHeadColor = "#003366"; //var WeekHeadColor="#18861B";//Background Color in Week header.
var SundayColor = "#A9A9A9"; //var SundayColor="#C0F64F";//Background color of Sunday.
var SaturdayColor = "#DCDCDC"; //Background color of Saturday.
var WeekDayColor = "#DCDCDC"; //Background color of weekdays.
var FontColor = "blue"; //color of font in Calendar day cell.
var TodayColor = "#AFEEEE"; //var TodayColor="#FFFF33";//Background color of today.
var SelDateColor = "#FFFF33"; //var SelDateColor = "#8DD53C";//Backgrond color of selected date in textbox.
...
Calendar.prototype.SetHour = function(intHour) {
    ...
    if (TimeMode === 24) {
        ...
        alert("Hora solo puede ser 12 o 24");
    }
