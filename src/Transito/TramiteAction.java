      ...
      switch (cs.getOpcion()) {
        ...
        case Ctte.ePaso:
          ...
          if (bTramite.isTna() == true) {
            msg.add("error", new ActionMessage("mensaje", "El medio de tr&aacute;nsporte esta registrado como <font color='#FF0000'><strong>Tr&aacute;nsito No Arribado</strong></font>."));
          }
        ...
        case Ctte.eCierre:
          ...
          msg.add("error", new ActionMessage("bien", "El N&uacute;mero de Tr&aacute;nsito <font color='#FF0000'><strong>" + cs.getKey_cuo() + " / " + cs.getKey_year() + " - " + cs.getKey_nber() + "</strong></font> se Cancel&oacute;"));
          cs.setKey_cuo("");
        ...
        case Ctte.eEtiqueta:
          ...
          response.getWriter().write(etiqueta.genera(bTramite.getGestion(), bTramite.getAduana(), Integer.parseInt(bTramite.getRegistro()), cs.getCodusu()).toString());
          //cs.setOpcion(opcion);
          return null;
