...
public class eBusqManifiestoAction extends Action {
    
  public ActionForward execute(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException {
    ClaseSession cs = (ClaseSession)request.getSession().getAttribute("ClaseSession");
    
    
    eBusqManifiestoForm bman = (eBusqManifiestoForm)form;
    ...
    try {
      eClaseSqlmanif sql = new eClaseSqlmanif();

        String ans = "";
        String direccion = "busq_manifiesto";
        
        if (bman.getAopcion() == Ctte.eAplicacionDS2295) {
            ans = sql.pReadDataBase(request, Ctte.btebuscarManif);
            if (!ans.equals("")) {
        ...
        if (bman.getOpcion() == 4)
        {
                ...
                if (!ans.equals("")) {
                    ...
                    direccion = "reg_inf_docemq";
                    msg.add("error", new ActionMessage("bien", "Se grab&oacute; correctamente la Enmienda del D.S. 2295."));  
        ...
        if (bman.getOpcion() == 8)
        {
                ...
                if (!ans.equals("")) {
                    ...
                    msg.add("error", new ActionMessage("bien", "Se grab&oacute; correctamente la aplicaci&oacute;n del DS2295 del manifiesto."));                   
                    direccion = "busq_manifiesto";
                }
        ...
        if (bman.getOpcion() == 9)
        {
                ...
                if (!ans.equals("")) {
                    ...
                    msg.add("error", new ActionMessage("bien", "Se grab&oacute; correctamente la no aplicaci&oacute;n del DS2295 del manifiesto."));                   
                    direccion = "busq_manifiesto";
                }
